                         ...
                         if n == 2:
                              ...
                              if count == 0:
                                   ...
                                   if x == 1:
                                        ...
                                        cr_amt=0
                                        cur.execute('update customer_details set   cr_amt=cr_amt-'+str(amt) +  ' where acc_no=' +str(acc_no) )
                                        V_SQLInsert="INSERT  INTO transactions values ({} , '{}' , {} , {}) ".format(acc_no,dt.datetime.today(),amt,cr_amt) 
                                        cur.execute(  V_SQLInsert)
                                        conn.commit()
                                        print()
                                   ...
                                   if x== 2:
                                         ...
                                         cr_amt=0
                                         cur.execute('update customer_details set  cr_amt=cr_amt+'+str(amt) +  ' where acc_no=' +str(acc_no) )
                                         V_SQLInsert="INSERT  INTO transactions values ({} , '{}' , {} , {}) ".format(acc_no,dt.datetime.today(),cr_amt,amt)
                                         cur.execute(  V_SQLInsert)
                                         conn.commit()
                                         print()
                                         print('Account Updated Succesfully!!!!!')
